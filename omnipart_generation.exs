...
#   --size-threshold <int>        Minimum segment size in pixels for mask generation (default: 4000)
...
defmodule ArgsParser do
  ...
  def parse(args) do
    ...
    %{
      ...
      size_threshold: Keyword.get(opts, :size_threshold, 4000),
...
size_threshold = config.get('size_threshold', 4000)
