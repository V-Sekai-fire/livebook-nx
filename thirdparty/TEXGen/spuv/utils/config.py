...
def calc_num_train_steps(num_data, batch_size, max_epochs, num_nodes, num_cards=8, batch_accumulation=1, data_repeat=1):
    return int(num_data * data_repeat / (num_nodes * num_cards * batch_size * batch_accumulation) + 0.5) * max_epochs
...
def get_naming_convention(cfg):
    # TODO
    name = f"spuv_{cfg.system.backbone.num_layers}"
    return name
